...
train_size = 10000  # 0  # 000  # 0#000  # 1000000
batch_size = 25  # 256
validation_size = 200  # 0#0
hidden_size = 128
lr = 5e-4  # 0.0005
epochs = 30
seq_len = 20
...
def validate(data_loader, actor, reward_fn, render_fn=None, save_dir='.', num_plot=5):
    ...
    for batch_idx, batch in enumerate(data_loader):
        ...
        with torch.no_grad():
            ...
            # TODO: ta kainourgia prepei kai ta duo pros ta katw!!
            loss = torch.mean(advantage * tour_logp.sum(dim=1))

            rewards.append(torch.mean(-distanceTravelled))
...
def train(actor, num_nodes, train_data, valid_data, reward_fn,
    ...
    early_stopping = EarlyStopping(patience=20, verbose=True, delta=200)  # TODO: check how big should delta be
    ...
    for epoch in range(epochs):
        ...
        times, losses, rewards, critic_rewards, distances = [], [], [], [], []
        ...
        for batch_idx, batch in enumerate(train_loader):
            ...
            advantage = -distanceTravelled.mean()
...
model = Seq2SeqModelCVRP(STATIC_SIZE,
                         DYNAMIC_SIZE,
                         hidden_size,
