...
def train(actor, num_nodes, train_data, valid_data, reward_fn,
    ...
    # scheduler = StepLR(actor_optim, step_size=step, gamma=gamma)
    ...
    if modelName is None:
        modelName = "SeqToSeqActorCriticCVRP"
    ...
    plot_critic_estimate_and_loss(critic_losses_per_epoch, critic_estimate_per_epoch, experiment_details, folder_name=modelName)
...
if __name__ == '__main__':
    ...
    train_size = 90_000  # 0  # 000  # 0#000  # 1000000
    bs = 5  # 256
    validation_bs = 5
    ...
    experiment_details = f'actorCriticCVRP_epoch{epochs}_trainSize{train_size}_bs{bs}_valSize{validation_size}_hidden{hidden_size}_actlr{actor_lr}'
